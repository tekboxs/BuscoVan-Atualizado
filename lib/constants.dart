...
FirebaseFirestore kDatabase = FirebaseFirestore.instance;

class Collections {
  static get students => 'alunos';
  static get drivers => 'motorista';
}
...
kDefaultSnackBar(
  ...
  if (captalize) {
    Get.snackbar("$title".capitalize ?? "", "$message".capitalize ?? "",
        backgroundColor: color ?? Get.theme.errorColor,
